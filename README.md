---
website: "Instituto Politécnico de Viana do Castelo"          # Entre as aspas escreve o nome do website
date: "20/07/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://www.ipvc.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://www.ipvc.pt/declaracao-de-acessibilidade-e-usabilidade/" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Instituto Politécnico de Viana do Castelo"         # Entre as aspas escrever o nome do owner do website
